# Phan tich diem thi THPT 2020 của thành phố HCM
...
File raw thu được dưới dạng file HTML
...
Với file CSV đã làm sạch vẽ các biểu đồ thể hiện đắc điểm quan trọng của kỳ thi như 
